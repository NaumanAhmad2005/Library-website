...
export default function Reader() {
  ...
  const loadPdf = async (url) => {
    try {
      ...
      // Slightly reduce width to prevent accidental horizontal scrollbars
      let initialScale = (availWidth - 2) / viewport.width;
      initialScale = Math.max(0.2, Math.min(3, initialScale));
